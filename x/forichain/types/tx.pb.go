...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_12f67d0f7d6e4ccc, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_12f67d0f7d6e4ccc, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "forichain.forichain.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "forichain.forichain.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("forichain/forichain/tx.proto", fileDescriptor_12f67d0f7d6e4ccc) }

var fileDescriptor_12f67d0f7d6e4ccc = []byte{
	// 342 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x49, 0xcb, 0x2f, 0xca,
	0x4c, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x47, 0xb0, 0x4a, 0x2a, 0xf4, 0x0a, 0x8a, 0xf2, 0x4b, 0xf2,
	...
	0xab, 0xa4, 0x58, 0x1b, 0x40, 0xde, 0x71, 0xf2, 0x3d, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39,
	0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63,
	0x39, 0x86, 0x28, 0xe3, 0xf4, 0xcc, 0x92, 0x8c, 0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0xfd, 0x94,
	0xfc, 0xbc, 0xf4, 0xec, 0xca, 0xd2, 0x3c, 0x23, 0x63, 0x63, 0x43, 0x7d, 0xec, 0xbe, 0x2c, 0xa9,
	0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x47, 0x94, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x75, 0xa2,
	0xe5, 0xbe, 0x5c, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/forichain.forichain.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/forichain.forichain.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "forichain.forichain.Msg",
	...
	Metadata: "forichain/forichain/tx.proto",
}
